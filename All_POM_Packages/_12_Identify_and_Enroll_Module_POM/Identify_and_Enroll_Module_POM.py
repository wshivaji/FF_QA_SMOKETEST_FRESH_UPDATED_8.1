...
class Identify_And_Enroll_POM(web_driver, web_logger):
    ...
    def Create_New_Enrollment_using_Identify_and_Enroll(self):
        try:
            ...
            time.sleep(2)
            file_path = f"{Path(__file__).parent.parent.parent}\\All_Test_Data\\Common_Test_data\\dataset2\\img3.png"
    ...
    def verify_user_able_approve_enrollment(self):
        try:
            ...
            load_more_button = self.d.find_element(By.XPATH, Read_Identify_and_Enroll_Components().get_load_more_button_by_xpath())
