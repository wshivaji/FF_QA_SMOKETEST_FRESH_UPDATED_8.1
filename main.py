...
if __name__ == "__main__":
    ...
    # pytest.main(['-v', '--lf', '-m', 'system1', f'{system1_test_suite_path}', '--html', f'{system1_test_report_path}'])
    pytest.main(['-v', '--lf', '-m', 'system', f'{system2_test_suite_path}', '--html', f'{system2_test_report_path}'])
